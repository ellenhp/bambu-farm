...
namespace Slic3r
{
    ...
    struct FilamentInfo
    {
        ...
        MSGPACK_DEFINE(id, type, color, filament_id, brand, used_m, used_g, tray_id, distance, mapping_result);
    };
    ...
    public:
        ...
        MSGPACK_DEFINE(filaments_info, index, title, thumbnail_dir, thumbnail_name, thumbnail_url, gcode_name, gcode_url, gcode_dir, config_url, weight, prediction)
    };
    ...
    public:
        ...
        MSGPACK_DEFINE(job_id, design_id, profile_id, task_id, model_id, model_name, profile_name)
    };
    ...
    public:
        ...
        MSGPACK_DEFINE(task_id, task_model_id, task_project_id, task_profile_id, task_name, task_file, task_gcode_in_3mf, task_create_time, task_thumbnail_url, task_bed_type, task_bed_leveling, task_flow_cali, task_vibration_cali, task_layer_inspect, task_record_timelapse, task_weight, task_weightF, slice_info, task_partplate_idx, (int &)task_status, task_printer_dev_id, task_progress, printing_status, task_url, task_url_md5, parent_id)
    };
